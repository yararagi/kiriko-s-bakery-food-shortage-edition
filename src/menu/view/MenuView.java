...
public class MenuView {
    ...
    public void paintScritte(byte scelta){
        ...
        for(byte i=0;i<3;i++){
            raylib.text.DrawTextEx(fontRegular, scritte[i], new Vector2((int)((screenX/2) - (raylib.text.MeasureText(scritte[i], fontSize)/2)), 175+offsetScritte*i), fontSize, 0, (i==scelta) ? (new Color(164, 22, 26, 150)) : (Color.RAYWHITE));
        }
